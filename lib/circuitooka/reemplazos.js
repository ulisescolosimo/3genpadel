...
export async function obtenerReemplazosPendientes(partidoId = null) {
  try {
    let query = supabase
      ...
      .select(`
        *,
        partido:circuitooka_partidos (
          id,
          fecha_partido,
          estado
        ),
        jugador_original:usuarios!circuitooka_reemplazos_jugador_original_id_fkey (
          id,
          nombre,
          apellido
        ),
        jugador_reemplazo:usuarios!circuitooka_reemplazos_jugador_reemplazo_id_fkey (
          id,
          nombre,
          apellido
        )
