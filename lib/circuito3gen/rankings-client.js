 ...
 * @param {number} jugadoresPlayoff - Cantidad de jugadores para playoff (default: 4)
 * @returns {Object} Objeto con jugadores para playoff de ascenso y descenso
 */
export function identificarJugadoresPlayoffClient(rankings, jugadoresAscenso, jugadoresDescenso, cuposAscenso, jugadoresPlayoff = 4) {
  const idsQueAscienden = new Set(jugadoresAscenso.map(j => j.usuario_id))
