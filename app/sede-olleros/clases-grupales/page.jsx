...
import { ArrowLeft, Calendar, MapPin, Phone, Mail, Zap, Trophy, Clock, Users, LogIn } from 'lucide-react'
  ...
  const handleReservasClick = () => {
    if (!user) {
      toast({
        ...
        description: "Debes iniciar sesión para acceder al sistema de reservas.",
        variant: "default",
      })
      router.push('/login')
    } else {
