...
import { ArrowLeft, Calendar, MapPin, Phone, Mail, Zap, Trophy, Clock, Users } from 'lucide-react'
        ...
        <div className="max-w-6xl mx-auto mb-16">
                ...
                <div className="bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-[#E2FF1B]/50 transition-all duration-300 hover:bg-black/60 flex flex-col w-full">
                  ...
                  <div className="flex-grow flex flex-col justify-center">
                    <div className="flex flex-wrap justify-center gap-2">
                      <span className="bg-[#E2FF1B]/20 text-[#E2FF1B] px-3 py-1 rounded-full text-xs font-medium">Lunes a Viernes</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-[#E2FF1B]/50 transition-all duration-300 hover:bg-black/60 flex flex-col w-full">
                  ...
                  <div className="flex-grow flex flex-col justify-center">
                    <div className="text-center">
                      <p className="text-white text-lg font-bold mb-2">8:00 - 18:00 hs</p>
          ...
          <div className="bg-black/40 backdrop-blur-sm rounded-xl p-8 border border-white/10 mb-8">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Coordinar por WhatsApp</h3>
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Escribinos por WhatsApp para elegir tu nivel, día y horario para los entrenamientos grupales.
              </p>
              <Button
                onClick={() => openWhatsApp('Hola! Me gustaría coordinar un turno para entrenamientos grupales en Olleros. ¿Qué días y horarios tienen disponibles?')}
                className="bg-[#25D366] hover:bg-[#25D366]/90 text-white font-bold inline-flex items-center gap-2"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-8">
            ...
            <div>
              ...
              <div className="relative mb-3 md:mb-4">
                ...
                <button
                  onClick={nextImage}
                  className="absolute right-2 md face-right-4 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white p-1.5 md:p-2 rounded-full transition-colors"
                >
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="flex-1">
                  <h4 className="agt-spawning font-semibold text-white text-lg mb-1 group-hover:text-[#E2FF lowering] transition-colors">Teléfono</h4>
