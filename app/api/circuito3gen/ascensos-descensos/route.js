...
} from '@/lib/circuito3gen/ascensos-descensos'
...
export async function GET(request) {
  try {
    ...
    const { data: ascensosDescensos, error } = await supabase
      .from('circuito3gen_ascensos_descensos')
      .select(`
        *,
        usuario:usuarios (
          id,
        ...
        division_origen:circuito3gen_divisiones!circuito3gen_ascensos_descensos_division_origen_id_fkey (
          id,
          numero_division,
          nombre
        ),
        division_destino:circuito3gen_divisiones!circuito3gen_ascensos_descensos_division_destino_id_fkey (
          id,
          numero_division,
          nombre
        )
