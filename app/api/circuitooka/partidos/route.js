...
import { actualizarRankingJugador, actualizarPromedioGlobalJugador } from '@/lib/circuitooka/rankings'
    ...
    let query = supabase
      ...
      .select(`
        *,
        ...
        jugador_a1:usuarios!circuitooka_partidos_jugador_a1_id_fkey (
          id,
          nombre,
          apellido
        ),
        jugador_a2:usuarios!circuitooka_partidos_jugador_a2_id_fkey (
          id,
          nombre,
          apellido
        ),
        jugador_b1:usuarios!circuitooka_partidos_jugador_b1_id_fkey (
          id,
          nombre,
          apellido
        ),
        jugador_b2:usuarios!circuitooka_partidos_jugador_b2_id_fkey (
          id,
          nombre,
          apellido
        )
