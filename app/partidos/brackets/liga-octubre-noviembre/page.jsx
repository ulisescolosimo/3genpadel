...
export default function LigaOctubreNoviembrePage() {
  return (
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center bg-[#E2FF1B]/10 px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-[#E2FF1B] text-sm font-medium">Octubre/Noviembre 2025</span>
          </div>
          <h1 className="text-4xl font-bold mb-4">
            <span className="text-[#E2FF1B]">Liga Octubre/Noviembre</span>
          </h1>
          <p className="text-gray-300 text-lg">
            Brackets de la liga actual de Octubre/Noviembre 2025
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* C7 League Card */}
            <Link href="/partidos/brackets/liga-octubre-noviembre/c7">
            ...
            {/* C8 League Card */}
            <Link href="/partidos/brackets/liga-octubre-noviembre/c8">
              <div className="bg-black/20 backdrop-blur-sm rounded-xl border border-white/10 p-6 hover:border-[#E2FF1B]/50 transition-all duration-300 cursor-pointer group">
                <div className="text-center">
                  <Trophy className="h-8 w-8 text-[#E2FF1B] mx-auto mb-3" />
                  <h2 className="text-lg font-semibold text-white mb-3">
